...
<p>
    ...
    <h2>B) ServletConfig Methodlarına Bakalım.</h2>
        <code>public String getServletName(); ==> <strong>Çalışmakta olan servlet adını alır.</strong> <br>  </code>
        <code>public String getInitParameter(String name); ==> <strong>Adı gönderilen parametrenin değerini döndürür.</strong>  <br> </code>
        <code>public Enumeration<String> getInitParameterNames(); ==> <strong>Parametre adını almamızı sağlar</strong>  <br> </code>
